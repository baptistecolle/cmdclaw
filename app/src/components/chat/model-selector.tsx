...
const ANTHROPIC_MODELS: ModelOption[] = [
  { id: "claude-sonnet-4-20250514", name: "Claude Sonnet 4", provider: "anthropic", providerLabel: "Anthropic" },
];

const OPENAI_MODELS: ModelOption[] = [
  { id: "gpt-5.1-codex-max", name: "GPT-5.1 Codex Max", provider: "openai", providerLabel: "ChatGPT" },
  { id: "gpt-5.1-codex-mini", name: "GPT-5.1 Codex Mini", provider: "openai", providerLabel: "ChatGPT" },
  { id: "gpt-5.2", name: "GPT-5.2", provider: "openai", providerLabel: "ChatGPT" },
  { id: "gpt-5.2-codex", name: "GPT-5.2 Codex", provider: "openai", providerLabel: "ChatGPT" },
  { id: "gpt-5.1-codex", name: "GPT-5.1 Codex", provider: "openai", providerLabel: "ChatGPT" },
];

const GOOGLE_MODELS: ModelOption[] = [
  { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro", provider: "google", providerLabel: "Gemini" },
