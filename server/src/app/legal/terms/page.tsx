  ...
  return (
    <article className="mx-auto">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        HeyBap offer and services (hereinafter referred to as the
        &quot;Services&quot;). Each Service presented on the Site is accompanied by a description
        stating its essential characteristics. This description may include descriptions,
        photographs, and graphics that are provided for illustrative purposes only and may be
        subject to modification/update on the Site.
      </p>
